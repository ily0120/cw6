public class Main {
    public static void main(String[] args) {
        ...
        Ksiazka ksiazka2 = new Ksiazka("Hobbit", 1937, "J.R.R. Tolkien", 300);
        Film film1 = new Film("Zielona Mila", 1999, "Frank Darabont", 189);
        Film film2 = new Film("Incepcja", 2010, "Christopher Nolan", 148);
        ...
        mediaArray[1] = ksiazka2;  // Obiekt Ksiazka przechowywany jako MediaBiblioteczne
        mediaArray[2] = film1;     // Obiekt Film przechowywany jako MediaBiblioteczne
        mediaArray[3] = film2;     // Obiekt Film przechowywany jako MediaBiblioteczne
